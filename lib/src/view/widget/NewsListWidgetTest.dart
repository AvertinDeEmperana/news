...
class NewsListWidgetTest<AbstractNewsListVM> extends StatefulWidget {
  final List<Article> articles;
  const NewsListWidgetTest({Key? key, required this.articles}) : super(key: key);

  @override
  _NewsListWidgetTest<AbstractNewsListVM> createState() => _NewsListWidgetTest<AbstractNewsListVM>();
}

class _NewsListWidgetTest<AbstractNewsListVM> extends State<NewsListWidgetTest<AbstractNewsListVM>> {
