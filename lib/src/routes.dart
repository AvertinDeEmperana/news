...
import 'package:news/src/view/screen/news_details_screen.dart';
import 'package:news/src/view/screen/search_result_screen.dart';
import 'package:news/src/view/screen/splash_screen.dart';
...
const groupTabRouter =
    AutoRoute(path: 'group/:id', page: GroupScreen, children: [
  AutoRoute(
    path: 'tab1',
    name: 'NewsListRouter',
  ...
  AutoRoute(
    ...
    page: EmptyRouterPage,
    children: [
      AutoRoute(path: '', page: SavedNewsScreen),
      RedirectRoute(path: '*', redirectTo: ''),
    ],
  ),
]);
